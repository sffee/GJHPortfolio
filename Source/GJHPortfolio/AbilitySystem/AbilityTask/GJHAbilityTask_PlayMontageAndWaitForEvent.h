...
#include "GJHAbilityTask_PlayMontageAndWaitForEvent.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FPlayMontageAndWaitForEventDelegate, FGameplayEventData, EventData);

UCLASS()
class GJHPORTFOLIO_API UGJHAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UGJHAbilityTask_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
	...
	void SetNextSection(const FName NextSectionName);
